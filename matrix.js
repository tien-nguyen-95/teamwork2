...
function sumMargin(arr,row ,col){
    ...
    return `Total Margin: ${sumTop} + ${sumBot} + ${sumLeft} + ${sumRight} - ${arr[0][0]} - ${arr[col-1][0]} - ${arr[0][row-1] } - ${arr[col-1][row-1]}`;
}
function main(){
    ...
    if(validCol && validRow){
        ...
        let totalRow = TotalRow(matrix,col,row);
